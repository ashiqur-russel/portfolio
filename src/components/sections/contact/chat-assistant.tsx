...
const QUICK_OPTIONS: QuickOption[] = [
  ...
  {
    text: "💼 Past Projects",
    message: "Could you share some examples of Ashiqur's past projects?",
  },
  {
    text: "⚡ AI Integration",
    message: "What kind of AI features can Ashiqur implement in projects?",
  },
];
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Hi! I'm Ashiqur's AI assistant. I can help you explore his skills, experience, and how he can support your project. What would you like to know?",
      timestamp: new Date(),
    },
  ]);
