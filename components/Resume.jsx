      ...
      <div className="page text-black mx-auto">
        ...
        <main className="mt-2 space-y-4">
          ...
          <section className="border-t border-black grid grid-cols-[1fr,5fr] gap-2 items-baseline pt-2">
            <div className="font-extrabold text-xxs tracking-tight">Contact</div>
            <div className="text-xxs tracking-tight grid grid-cols-3 gap-x-2 gap-y-2 leading-none">
              ...
              <a target="blank" href="https://github.com/verascheunert">github.com/verascheunert</a>
              <p>+49 151 65181623</p>
              <a target="blank" href="https://verascheunert.com">verascheunert.com</a>
              <a target="blank" href="https://www.linkedin.com/in/verascheunert/">linkedin.com/in/vera-scheunert</a>
            </div>
          </section>
          ...
          <section className="border-t border-black grid grid-cols-[1fr,5fr] gap-2 pt-2 items-baseline">
            <div className="font-extrabold text-xxs tracking-tight">Work Experience</div>
            <ul className="space-y-4">
              {/* Example of one work experience entry */}
              <div>
                <div className="flex text-xxs items-baseline">
                  <div>
                    <h3 className="text-xs font-bold">Software Engineering Team Lead</h3>
                    <div className="text-xxs">Aignostics</div>
                  </div>
                  <div className="text-xxs font-bold ml-auto">Jun 2024 - Present</div>
                </div>
                <div>
          ...
          {/* Projects Section */}
          <section className="border-t border-black grid grid-cols-[1fr,5fr] gap-2 pt-2 items-baseline">
            <div className="font-extrabold text-xxs tracking-tight">Projects</div>
            <ul>
              <li className="grid grid-cols-[1fr,2fr] gap-2 items-baseline">
                <div>
                  <h3 className="tracking-tight flex items-baseline flex-col">
                    <span className="text-xs font-bold">Prosumio: Game-based Learning Platform</span>
                    <a target="blank" className="block text-xxs underline-offset-1 ml-2" href="https://prosumio.de/">https://prosumio.de/</a>
                  </h3>
                </div>
                <div>
                  <p className="text-xxs tracking-tight leading-relaxed mt-1">
                    Developed a game-based learning app (Flutter) and a teacher portal (Next.js) to facilitate custom lesson creation and interactive learning experiences.
                  </p>
                  <p className="text-xxs tracking-tight mt-4">Flutter, Next.js, Python</p>
                </div>
              </li>
          ...
          {/* Education Section */}
          <section className="border-t border-black grid grid-cols-[1fr,5fr] gap-2 pt-2 items-baseline">
            <div className="font-extrabold text-xxs tracking-tight">Education</div>
            <ul className="space-y-4">
              <div>
                <div className="flex text-xxs items-baseline">
                  <div>
                    <h3 className="text-xs font-bold">Master of Arts in Communication Management</h3>
                    <div className="text-xxs">University of Leipzig</div>
                  </div>
                  <div className="text-xxs font-bold ml-auto">Oct 2018 - Jul 2021</div>
                </div>
                <div>
            ...
            <div>
              <ul className="space-y-2">
                <li className="grid grid-cols-[1fr,2fr] gap-x-2">
                  <div className="text-xxs font-bold tracking-tight">Programming Languages</div>
